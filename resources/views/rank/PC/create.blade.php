    ...
    <form class="layui-form" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" id="keyword" name="userid" style="display: none" value="{{\Illuminate\Support\Facades\Auth::user()->id}}" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="dohost" name="dohost" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
               <div style="color: red"> 网址不要带http 和 https</div>
            </div>

            <div id="dohosterr" ></div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="searchengines" name="searchengines" class="valid">
