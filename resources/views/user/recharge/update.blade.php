    ...
    <form class="layui-form" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" id="keyword" name="userid" style="display: none" value="{{$user->id}}" lay-verify="required"
                       autocomplete="off" class="layui-input">
                <input type="text" id="keyword" name="update_people" style="display: none" value="{{\Illuminate\Support\Facades\Auth::user()->id}}" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
